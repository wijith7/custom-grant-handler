...
package org.wso2.sample.identity.oauth2.grant.internal;
...
public class CustomClaimCallbackHandlerServiceComponent {

    private static Log log = LogFactory.getLog(CustomClaimCallbackHandlerServiceComponent.class);
